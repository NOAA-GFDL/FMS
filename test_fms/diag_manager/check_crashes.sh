...
touch input.nml
sed '/tile/d' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
...
touch input.nml
sed '/new_file_freq_units/d' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/new_file_freq_units: hours/new_file_freq_units: mullions/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed '/file_duration_units/d' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/file_duration_units: hours/file_duration_units: mullions/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/freq_units: hours/freq_units: mullions/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/freq: 6/freq: -666/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/realm: ATM/realm: mullions/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/kind: float/kind: mullions/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/reduction: average/reduction: mullions/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/reduction: average/reduction: diurnal0/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/reduction: average/reduction: diurnal99r/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/reduction: average/reduction: pow0/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/reduction: average/reduction: pow99r/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
...
touch input.nml
sed 's/grid_type: latlon/grid_type: ice_cream/g' $top_srcdir/test_fms/diag_manager/diagTables/diag_table_26 > diag_table.yaml
run_test test_diag_yaml 1 $parser_skip && echo "It worked?"
if [ $? -eq 0 ]; then
