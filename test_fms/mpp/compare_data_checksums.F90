...
public :: compare_checksums

interface compare_checksums
  module procedure compare_checksums_2D_r4
  module procedure compare_checksums_3D_r4
  module procedure compare_checksums_2D_r8
...
contains
  ...
  end subroutine compare_checksums_3D_r8

end module compare_data_checksums
