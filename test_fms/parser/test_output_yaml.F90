...
call yaml_out_add_level2key( 5, "order", k1(1))

call fms_f2c_string (k2(1)%key1,"Drink")
call fms_f2c_string (v2(1)%val1, "Iced tea")
call yaml_out_add_level2key(4, "Food", k2(1))
...
call yaml_out_add_level2key(4, "Food", k2(2))
...
call yaml_out_add_level2key(4, "Food", k2(3))
...
if(test_lvl2keys) then
  ...
  call yaml_out_add_level2key( 7, "order 4",k1(1))
  call yaml_out_add_level2key( 5, "sides", k2(1))
  call yaml_out_add_level2key( 8, "specials",  k2(2))
