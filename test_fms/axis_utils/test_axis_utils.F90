...
integer           :: unit, ierr, io
  ...
  out_linear_dst(1:n_dst)  = (/ 313.772830731158,  314.354434665370,  314.839457748187, 314.910045389784, &
 ...
 out_cubic_dst(1:n_dst) = (/ -313.942318474633, 314.503163655656, 314.913470956341, 315.055635714636, &
