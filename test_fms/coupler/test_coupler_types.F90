...
time_t = set_time(seconds=1, days=1)
! 1d -> 2d, 3d
call coupler_type_copy(bc_1d_new, bc_2d_cp, data_grid(1), data_grid(2), data_grid(3), data_grid(4), " ", (/ 0 /), time_t ) 
call coupler_type_copy(bc_1d_new, bc_3d_cp, data_grid(1), data_grid(2), data_grid(3), data_grid(4), data_grid(5), " ", (/ 0 /), time_t ) 
...
call coupler_type_copy(bc_2d_new, bc_3d_cp, data_grid(1), data_grid(2), data_grid(3), data_grid(4), data_grid(5), " ", (/ 0 /), time_t ) 
call coupler_type_copy_data(bc_2d_new, bc_2d_cp)
call coupler_type_copy_data(bc_2d_new, bc_3d_cp)
call coupler_type_destructor(bc_2d_cp)
call coupler_type_destructor(bc_3d_cp)
! 3d -> 2d, 3d
call coupler_type_copy(bc_3d_new, bc_2d_cp, data_grid(1), data_grid(2), data_grid(3), data_grid(4), " ", (/ 0 /), time_t ) 
...
call coupler_type_destructor(bc_2d_cp)
call coupler_type_destructor(bc_3d_cp)
! with registering diag fields TODO
!call coupler_type_copy(bc_2d_new, bc_2d_cp, data_grid(1), data_grid(2), data_grid(3), data_grid(4), "diag_name", axes, time_t, suffix=suffix) 
!call coupler_type_copy(bc_2d_new, bc_2d_cp, data_grid(1), data_grid(2), data_grid(3), data_grid(4), "diag_name", axes, time_t, suffix=suffix) 

! coupler_type_redistribute_data
! just using the same domain
call mpp_define_domains((/1, nlon, 1, nlat/), layout, Domain_out, name="test_coupler_redistributed")
call coupler_type_redistribute_data(bc_2d_new, Domain, bc_2d_new, domain_out, complete=.true.)
call coupler_type_redistribute_data(bc_3d_new, Domain, bc_3d_new, domain_out, complete=.true.)
call coupler_type_destructor(bc_2d_cp)
call coupler_type_destructor(bc_3d_cp)
