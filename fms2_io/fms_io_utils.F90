...
function string_compare(string1, &
                        string2, &
                        ignore_case) &
    result(same)
...
subroutine append_to_list(list, &
                          string)
...
!! @internal
subroutine domain_tile_filepath_mangle(dest, &
                                       source, &
                                       domain_tile_id)
...
!! @internal
subroutine restart_filepath_mangle(dest, &
                                   source)
    ...
    call string_copy(dest, &
                     source(1:i-1)//".res"//source(i:len_trim(source)))
