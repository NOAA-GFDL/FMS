...
real(kind=RKIND), public, parameter :: OMEGA              = 7.292E-5_r8_kind   !< Rotation rate of the Earth [1/s]
real(kind=RKIND), public, parameter :: GRAV               = 9.80_r8_kind       !< Acceleration due to gravity [m/s^2]
...
real(kind=RKIND), public, parameter :: KAPPA    = 2.0_r8_kind/7.0_r8_kind   !< RDGAS / CP_AIR [dimensionless]
