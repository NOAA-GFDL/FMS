...
character(len=20), public, parameter :: constantsR4_version = 'FMSConstantsR4: GFS '
...
real(kind=r4_kind),   public, parameter :: RADIUS             = 6.3712E+6_r8_kind  !< Radius of the Earth [m]
real(kind=r4_kind),   public, parameter :: OMEGA              = 7.2921E-5_r8_kind  !< Rotation rate of the Earth [1/s]
real(kind=r8_kind), public, parameter :: GRAV_8             = 9.80665_r8_kind    !< Acceleration due to gravity [m/s^2] (REAL(KIND=8))
real(kind=r4_kind),   public, parameter :: GRAV               = GRAV_8             !< Acceleration due to gravity [m/s^2]
...
real(kind=r4_kind), public, parameter :: RDGAS    = 287.05_r8_kind            !< Gas constant for dry air [J/kg/deg]
real(kind=r4_kind), public, parameter :: RVGAS    = 461.50_r8_kind            !< Gas constant for water vapor [J/kg/deg]
real(kind=r4_kind), public, parameter :: HLV      = 2.500E6_r8_kind           !< Latent heat of evaporation [J/kg]
real(kind=r4_kind), public, parameter :: HLF      = 3.3358e5_r8_kind          !< Latent heat of fusion [J/kg]
real(kind=r4_kind), public, parameter :: HLS      = HLV + HLF                 !< Latent heat of sublimation [J/kg]
real(kind=r4_kind), public, parameter :: CP_AIR   = 1004.6_r8_kind            !< Specific heat capacity of dry air
...
real(kind=r4_kind), public, parameter :: KAPPA    = RDGAS/CP_AIR              !< RDGAS / CP_AIR [dimensionless]
...
real(kind=r4_kind), public, parameter :: CON_CLIQ = 4.1855E+3_r8_kind         !< Specific heat H2O liq [J/kg/K]
real(kind=r4_kind), public, parameter :: CON_CSOL = 2.1060E+3_r8_kind         !< Specific heat H2O ice [J/kg/K]
...
real(kind=r4_kind), public, parameter :: KELVIN   = 273.15_r8_kind            !< Degrees Kelvin at zero Celsius [K]
real(kind=r4_kind), public, parameter :: TFREEZE  = 273.15_r8_kind            !< Freezing temperature of fresh water [K]
...
real(kind=r4_kind), public, parameter :: RADCON     = ((1.0D+02*GRAV)/(1.0D+04*CP_AIR))*SECONDS_PER_DAY  !< Factor to convert flux divergence
