...
character(len=20), public, parameter :: constantsR4_version = 'FMSConstantsR4: GFDL'
...
real(kind=r4_kind), public, parameter :: RADIUS             = 6371.0E+3_r8_kind  !< Radius of the Earth [m]
real(kind=r4_kind), public, parameter :: OMEGA              = 7.292E-5_r8_kind   !< Rotation rate of the Earth [1/s]
real(kind=r4_kind), public, parameter :: GRAV               = 9.80_r8_kind       !< Acceleration due to gravity [m/s^2]
...
real(kind=r4_kind), public, parameter :: RDGAS    = 287.04_r8_kind            !< Gas constant for dry air [J/kg/deg]
...
real(kind=r4_kind), public, parameter :: HLF      = 3.34E5_r8_kind            !< Latent heat of fusion [J/kg]
real(kind=r4_kind), public, parameter :: HLS      = HLV + HLF                 !< Latent heat of sublimation [J/kg]
real(kind=r4_kind), public, parameter :: KAPPA    = 2.0_r8_kind/7.0_r8_kind   !< RDGAS / CP_AIR [dimensionless]
