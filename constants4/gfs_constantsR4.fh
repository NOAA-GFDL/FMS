...
real(kind=RKIND), public, parameter :: RDGAS    = 287.05_r8_kind            !< Gas constant for dry air [J/kg/deg]
...
real(kind=RKIND), public, parameter :: HLF      = 3.3358e5_r8_kind          !< Latent heat of fusion [J/kg]
real(kind=RKIND), public, parameter :: HLS      = HLV + HLF                 !< Latent heat of sublimation [J/kg]
real(kind=RKIND), public, parameter :: CP_AIR   = 1004.6_r8_kind            !< Specific heat capacity of dry air
...
real(kind=RKIND), public, parameter :: KELVIN   = 273.15_r8_kind            !< Degrees Kelvin at zero Celsius [K]
real(kind=RKIND), public, parameter :: TFREEZE  = 273.15_r8_kind            !< Freezing temperature of fresh water [K]
