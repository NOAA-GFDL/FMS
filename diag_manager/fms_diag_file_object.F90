...
subroutine add_axes(this, axis_ids, diag_axis, naxis, yaml_id, buffer_id, output_buffers)
  ...
  type(outputBuffer_type),                 intent(inout) :: output_buffers(:) !< Array of output buffers
...
subroutine write_field_data(this, field_obj, buffer_obj)
  ...
  type(outputBuffer_type),                 intent(in), target :: buffer_obj(:)  !< The buffer object with the data
