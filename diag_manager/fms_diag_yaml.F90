...
pure logical function has_file_fname (obj)
  type(diagYamlfile_type), intent(out) :: obj !< diagYamlfile_type object to initialize
...
pure logical function has_var_fname (obj)
  type(diagYamlvar_type), intent(out) :: obj !< diagYamlvar_type object to initialize
...
pure logical function has_diag_title (obj)
  type(diagYamldiag_type), intent(out) :: obj !< diagYamldiag_type object to initialize
