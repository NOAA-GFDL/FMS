...
end type outputBuffer_type

! public types
public :: outputBuffer_type
...
logical function fms_diag_output_buffer_init(buffobjs, buff_list_size)
  type(outputBuffer_type), allocatable, intent(out) :: buffobjs(:)    !< an array of buffer container types
                                                                      !! to allocate
...
subroutine set_buffer_id(this, id)
  class(outputBuffer_type), intent(inout) :: this !< buffer object to set id for
...
subroutine flush_buffer(this)
  class(outputBuffer_type), intent(inout) :: this !< any buffer object
...
subroutine allocate_buffer(this, buff_type, ndim, buff_sizes, field_name, diurnal_samples)
  class(outputBuffer_type), intent(inout), target :: this !< 5D buffer object
...
subroutine get_buffer (this, buff_out, field_name)
  class(outputBuffer_type), intent(in)   :: this                !< 5d allocated buffer object
...
subroutine initialize_buffer (this, fillval, field_name)
  class(outputBuffer_type), intent(inout) :: this       !< allocated 5D buffer object
...
subroutine add_axis_ids(this, axis_ids)
  class(outputBuffer_type), intent(inout) :: this        !< Buffer object
...
function get_field_id(this) &
  result(res)
  class(outputBuffer_type), intent(in) :: this        !< Buffer object
  integer :: res
...
subroutine write_buffer(this, fileobj, unlim_dim_level)
  class(outputBuffer_type), intent(in) :: this            !< buffer object to write
