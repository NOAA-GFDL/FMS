...
!   </DATA>
!<  use_mpp_io Default = .false.  When true, uses mpp_io for IO.
...
type grid_type
  ...
  logical                         :: is_ug
  integer                         :: nxl_me
  integer, pointer                :: ls_me =>NULL(),  le_me =>NULL()  ! unstruct domain
...
end subroutine get_ocean_model_area_elements_use_mpp_io
! </SUBROUTINE>
!#######################################################################
