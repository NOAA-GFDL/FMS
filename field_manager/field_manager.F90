...
if (use_field_table_yaml) then
  ...
  call mpp_error(NOTE, "field_manager_init:: You are using the yaml version of the field_table.The legacy field_table format will be deprecated in a future release, please switch to the yaml format.")
